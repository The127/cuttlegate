...
type Config struct {
	...
	CORSAllowedOrigins []string // comma-separated exact origins for CORS on the eval endpoint; empty = CORS disabled
}
...
// parseCORSOrigins splits a comma-separated origins string, trims whitespace,
// and discards empty elements. Returns nil when the input is empty.
